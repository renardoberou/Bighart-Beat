...
const MAIN_JS_TOKEN = 'v=synth-note-engine-status-20260524';
const localAssetTokenPattern = /[?&]v=(?:boost-week|hihat-accent(?:-bloom)?|hihat-open-contract|hihat-gain-stage|hihat-open-body|hihat-open-decay|hihat-flutter(?:-velocity)?|hihat-metal-budget|hihat-metal-air|hihat-velocity-tail|hihat-place-audition|ether-mode-audition|ratchet-edit-audition|synth-cleanup|synth-note-engine-status|syn-pitch-cap|hihat-idm-spark)-\d{8}(?:-[a-z0-9-]+)?/g;
