...
(function (root) {
  ...
  function resolveSynthVoiceSpec(engineId, params) {
    ...
    const filterDecaySec = clamp(decaySec * profile.filterDecay * ((profile.personality === 'acid-bass' ? 1.45 : 1.06) - shape * 0.18), filterAttackSec + 0.0005, profile.personality === 'acid-bass' ? Math.max(decaySec * 1.4, 0.08) : decaySec);
